...
namespace ASPnet
{
    public partial class Homework123 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < strPoker.Length; i++){ Response.Write("<img src='HomeWork/後端作業三/poker_img/" + strPoker[i] + ".gif'/>"); }//Length運算子用以取得strPoker的總數量。顯示出所有圖檔。
            ...
            for (int i = 0; i < strPoker.Length; i++)
            {
                ...
                {
                    case 0:
                        strPlay1 += "<img src='HomeWork/後端作業三/poker_img/" + strPoker[i] + ".gif'/>";
                        break;
                    case 1:
                        strPlay2 += "<img src='HomeWork/後端作業三/poker_img/" + strPoker[i] + ".gif'/>";
                        break;
                    case 2:
                        strPlay3 += "<img src='HomeWork/後端作業三/poker_img/" + strPoker[i] + ".gif'/>";
                        break;
                    case 3:
                        strPlay4 += "<img src='HomeWork/後端作業三/poker_img/" + strPoker[i] + ".gif'/>";
                        break;
                }
            }
