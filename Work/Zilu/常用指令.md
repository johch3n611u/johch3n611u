...
HDE => Home Delivery Express

HDS => Home Delivery

HDS-HDE => Home Delivery

HDE-HDS => Home Delivery

CCE => Click and Pick Up

SDD => Supplier Direct Delivery 供應商直接送貨
...
shipping delivery date ? 航運交貨日期

SDD_VOUCHER 供應商代金卷

MB_VOUCHER 移動裝置代金卷

SC可能代表"Senior Citizen"，這是一種通常用於指稱年長者的詞彙，而PWD可能代表"Person with Disability"，這是一種通常用於指稱身心障礙者的詞彙。
...
https://api.cmb8j9fjhz-aswatsona1-s1-public.model-t.cc.commerce.ondemand.com/hac/console/impex/import
...
https://backoffice.cmb8j9fjhz-aswatsona1-s1-public.model-t.cc.commerce.ondemand.com/backoffice/
...
1. component，component type，component name，component ref
2. slot ， slot uid，slot name，要裝的component
3.slotforpage ， relation，position

INSERT slotName的都不用管，應該是他們有拆開寫
...
開新類別必須去定義他的上一層 `elabasia-e2-angular-v2\projects\wtc\src\assets\translations\translation-chunks-config.ts`

![image](https://user-images.githubusercontent.com/46659635/235890281-e85c9864-e66b-444a-8de2-212a82a0a4fe.png)
...
tip ： mq queue 名稱重複因為他們 mq server 沒重啟，需要換名稱才能撈到

## git count

PS D:\Desk\Cases\Zilu\Case\elabasia-e2-angular-v2> 

git rev-list --count --since=2023-01-01 --until=2023-10-04 --author=allen_aswatson --all

175

git rev-list --count --since=2023-01-01 --until=2023-10-04 --all

19207

## IMPEX 新增 CONFIG 流程

1. GL-E2A 網站找 API 網址補上後綴 hac/console/impex/import
2. 查詢舊 IMPEX 語法更改後貼到後台新增即可 https://github.com/ASWG-HK-eLab/elabasia-e2-hybris-asia/pull/7222/files
3. 新增 IMPEX 專案內的檔案版控
4. E2 讀取 API 新增 GOBLE TS CONFIG 跟 TS 檔案內的

## ng serve 執行速度

https://rhum1-dev.medium.com/angular-10-how-to-optimize-scss-compilation-826ac5cc7ba3

https://github.com/angular/angular/issues/42100
...
"serve": {
          ...
          "configurations": {
            "prod": {
              "browserTarget": "project:build:production,project,project-prod"
            },
            "dev": {
              "browserTarget": "project:build:development,project"
            }
          },
...
### Slot 或 Component 內的 Properties Content 根據語言要點選地球圖示才會看到相對印的內容