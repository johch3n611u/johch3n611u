...
如果有英文盖章件， 不用公证。 成绩单也需要中英文盖章件或者公证

最好是所有的高等学历都体现，ACS会根据按照哪个学历来减年限最有利于申请人的原则来审核

關於申請職評的工作證明, 還有一個地方想詢問,
我有一個工作是透過人力仲介(A公司) 在(B公司)全職工作, 由(A公司) 發薪與投勞工保險,
那麼工作證明要準備A公司或B公司的呢? 或是二者都需要?

在簽証階段時, 也可以用一樣的工作證明嗎?
B公司出具相关证明
```

https://bbs.fcgvisa.com/t/acs/40346

```
之前ACS在职业评估指南中明确说明了提供误导性或虚假信息或者剽窃其他人信息的申请人可能在12个月内不能重新提交申请，但是最新版中把这个时间给抹掉了，可能之后是要视情况而定了。另外，ACS在最新的指南中表示已根据教育、技能和就业部的要求制定了识别和管理身份和文件欺诈的流程。 如果有任何确凿证据表明申请人存在提供虚假信息或欺诈行为，即使已拿到了评估函， ACS仍有权撤销您的评估函并将此事报告给移民局 ，所以小编提醒大家提交的所有信息都要以您的真实情况为基础，别到最后得不偿失呀

之前ACS对申请人的薪资证明材料的要求是提供每段工作所涉及的年限中每年年初和年末的， 最新的指南中只要求申请人提供每段工作履历的开始和结束的月份 (如果当前在职则提供最近月份的)就可以。另外，ACS要求提供的两种薪资证明材料中至少有一种是由雇主以外的机构开具的。除此之外，ACS也将公积金纳入认可的薪资证明材料。

最新认可的薪资证明材料（至少提供以下材料中的两种）：

个税缴费记录（显示申请人&公司名称），不接受申请人填写的税务文件；
工资单（显示申请人&公司名称）；
社保/养老金/公积金缴费记录（显示申请人&公司名称）；
显示雇主支付工资的银行流水（显示申请人名字，不再要求显示公司名称）。
另外，之前ACS在指南中明确说明了如果申请人未能提供认可的薪资证明材料会导致评估不合格，可能经过这一年多的审理ACS也意识到申请人提供这些薪资证明材料的困难性，所以在最新的指南中表示他们在综合评估申请时会考虑到申请人获得10年前的薪资证明材料的困难性。因此，如果您10年前的薪资证明材料确实拿不到，那就可以写一个解释信看ACS如何评估了。

之前ACS对申请人的身份证明材料只要求提供护照首页就可以，最新的指南中要求申请人提供三种身份证明材料，包括护照首页（申请人要确保在申请中使用的姓名与您护照上的姓名一致）以及其他两种由申请人出生国或现居住国政府签发的身份证件，其中至少一种带有申请人的照片。

ACS最新职业评估指南中对纸质原始文件和电子原始文件的上传做了一个单独说明。

如果上传的原始文件是纸质的：

需要上传原始文档的高质量彩色扫描件（至少300dpi），应以相同的分辨率(dpi) 扫描所有文档；
确保文档完整扫描，并且所有边缘都要清晰可见，以免文档看起来被裁剪。
将每个学历和工作履历的所有文档合并为一个PDF文档。
如果上传的原始文件是电子版的：

上传原始文件；
数字签名的文档不要和其他文档合并；
如果原始PDF文档有密码，则需要附上一个单独的PDF文档，列一个表，写上文件名和对应的密码。


最新的职业评估指南上表示 ACS不再认可AQF文凭级别的计算机相关资格证书（Vendor Certifications ），但是申请RPL的申请人仍可以上传已完成的所有计算机相关资格证书以证明他们所具备的提名职业相关的知识是通用的。

除了以上ACS职业评估指南上的6点变化外，ACS的最新材料清单中还有以下两点变化：

我们都知道澳洲留学生本科及以上学历，申请用于技术移民的职业评估，要求澳洲学历后有一年工作经验或者完成了ACS专业年项目（ACS Professional Year Program），针对完成ACS专业年项目的情况，之前的材料清单没要求申请人提交相关的证明材料，不过 最新的材料清单要求申请人提交ACS专业年课程的完成信和成绩单 。

最新的材料清单对推荐信的要求有略微的区别，最新的推荐信要求必须包含以下信息：

工作的起止日期（格式DD/MM/YYYY，如果当前在职，则推荐信上应表明是“current”工作）
职位名称（如“软件工程师”）
工作职责描述（以确定您的工作经验与提名职业的相关性，并且每段工作履历的推荐信需要是独特的）
每周工作小时数（全职或兼职以及每周实际工作时间）
工作所在的国家
推荐人的联系方式，如电话号码和正式的电子邮箱（非个人电子邮箱）
```
...
[(大陸資料很多)飛出國論壇](https://bbs.fcgvisa.com/c/homeaffairs/74/l/top)
